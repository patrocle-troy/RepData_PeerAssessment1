...
* The **mean** total number of steps day is: **`r meanD`**
* The **median** is: **`r medianD`**
...
The maximum average number of steps for a 5-minute interval is `r maxS`. It occurs at interval **`r aMaxS`**.
...
```
There are **`r nMissingData`** missing data.
...
* The **mean** total number of steps day is: **`r meanQD`**
* The **median** is: **`r medianQD`**
